...
@section('title', 'Добавление пользователя - SalaryCalc BY')

@section('content')
    <div class="page">
        <div class="card">
            <div class="card-header">
                <h3><i class="fas fa-user-plus"></i> Добавление пользователя</h3>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-with-icon password-wrapper">
                                ...
                                <i class="fas fa-eye toggle-password"
                                   ...
                                   style="position: absolute; right: 12px; top: 50%; transform: translateY(-50%); cursor: pointer; z-index: 10;"></i>
                            </div>
                            @error('password')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <select id="role" name="role" class="form-control @error('role') is-invalid @enderror" required>
                                ...
                                <option value="hr" {{ old('role') == 'hr' ? 'selected' : '' }}>Кадровик</option>
                                <option value="manager" {{ old('role') == 'manager' ? 'selected' : '' }}>Начальник</option>
